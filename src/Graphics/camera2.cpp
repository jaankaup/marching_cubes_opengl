...
// Konstruktori
Camera2::Camera2(const glm::vec3& cameraPosition, const glm::vec3& cameraTarget, const glm::vec3& upVector)
{
 ...
 * @return Matrix
 */
glm::mat4 Camera2::getMatrix() const
{
    return view;
}
 ...
 */
void Camera2::setView(const glm::vec3& cameraTarget)
{
 ...
 */
void Camera2::translate(const glm::vec3& newPos)
{
    position_ = newPos;
}
 ...
 */
void Camera2::rotateCamera(const float &xoffset, const float &yoffset)
{
    yaw   += xoffset;
    pitch += yoffset;
 ...
 * @param adjust muutos
 */
void Camera2::adjustSpeed(const float &adjust)
{
    camSpeed += adjust;
 ...
 * @param adjust muutos
 */
void Camera2::adjustSensitivity(const float &adjust)
{
 ...
 */
void Camera2::update(const float time)
{
    //deltaTime = time;
...
void Camera2::changeScene(const char number) const
{
